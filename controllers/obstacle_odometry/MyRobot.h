...
class MyRobot : public DifferentialWheels {
    private:
        ...
        /**
        * @brief this funtion calculates de position of the robot with the odometry ecuations
        * @param
        * @return
        *
        */
        ...
        */
        ...
        /**
        * @brief this funtion turns right 90 degrees
        * @param
        * @return
        *
        */
        ...
        /**
        * @brief this funtion turns left 90 degrees
        * @param
        * @return
        *
        */
